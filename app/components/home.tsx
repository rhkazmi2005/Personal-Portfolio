...
const Home = () => {
  return (
    <section id="home" className="flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 dark:bg-black w-full min-h-screen gap-4 m-0 p-0 overflow-hidden">
      <Card>
        <CanvasRevealEffect
          animationSpeed={4}
          containerClassName="bg-gradient-to-br from-purple-600 to-blue-600"
          colors={[[138, 43, 226], [59, 130, 246], [147, 51, 234]]}
        />
      </Card>
    </section>
  );
